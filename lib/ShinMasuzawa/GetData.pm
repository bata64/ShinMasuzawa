...
sub csv {
    ...
    return {
        ...
        judge => {
            judge_01 => $getjudge->{judge_1}||undef,
            judge_02 => $getjudge->{judge_2}||undef,
            judge_03 => $getjudge->{judge_3}||undef,
            judge_04 => $getjudge->{judge_4}||undef,
            judge_05 => $getjudge->{judge_5}||undef,
            judge_06 => $getjudge->{judge_6}||undef,
            judge_07 => $getjudge->{judge_7}||undef,
            judge_08 => $getjudge->{judge_8}||undef,
            judge_09 => $getjudge->{judge_9}||undef,
